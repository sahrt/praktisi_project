...
<html lang="en">
    ...
    <body>
         <nav class="navbar navbar-expand-lg  fixed-top bg-warning p-3  shadow-lg" >
            ...
            <ul class="navbar-nav" >
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="{{ route('member') }}">Beranda</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{route('type')}}">List type</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{route('contact-member')}}">Contact me</a>
                </li>
                 <li class="nav-item">
 ...
 @extends ('_layouts.layouts-toko.footer')